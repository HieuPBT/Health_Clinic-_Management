...
const Step1 = () => {
    ...
    return (
        <View style={Styles.container}>
            ...
            <CustomButton title="Tiếp" onPress={() => setStep(2)} disabled={!(name && address && phoneNumber && healthInsurance && ValidateInformation.validateInsuranceNumber(healthInsurance) && ValidateInformation.validatePhoneNumber(phoneNumber) && ValidateInformation.validateEmail(email))}/>
        </View>
    );
};
